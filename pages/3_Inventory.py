...
# Simple view switcher so we don't query everything at once
...
if view == "By Type":
    ...
    if summary:
        ...
        # Order columns and label nicely
...
# Keep Lots section as-is for now; not fetched when viewing By Series
lots = list_lots()
if lots and view == "By Type":
    st.subheader("Lots")
    st.dataframe(pd.DataFrame(lots))
